...
public class Approach2 {
	...
	public static void main(String[] args) {
		...
		List<Transaction> filterTransactions = filterTransactionByLocation(allTransactions,new TransactionPredicateByLocation());
		TransactionUtils.printTransactions(filterTransactions);
		
		System.out.println("\n\n");
		
		filterTransactions = filterTransactionsByAmount(allTransactions, new TransactionPredicateByAmount());
		TransactionUtils.printTransactions(filterTransactions);
	}
